...
from data.load_fighters import build_percentile_context, build_closeness_context
...
VERSION = os.environ.get("PIPELINE_VERSION", "v3").lower()
...
def run_pipeline(fighter_a: dict, fighter_b: dict) -> MatchupResponse:
    ...
    use_percentiles = VERSION in ("v3", "v4")
    ...
    closeness = build_closeness_context(ctx_a, ctx_b) if VERSION == "v4" else None
